...
class JianshuSpider(CrawlSpider):
    ...
    def parse_detail(self, response):
        ...
        item = ArticleItem(
            title=title, avatar=avatar, author=author, content=content,
            pub_time=pub_time, origin_url=response.url, article_id=article_id,
            subjects=subjects, word_count=word_count, comment_count=comment_count,
